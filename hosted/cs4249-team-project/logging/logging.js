...
// docs.google.com/forms/d/e/1FAIpQLSdMl_0v0sLjRwFPfoV1CT2NMI1as54yJRO91ks6_rgW5a-4Nw/viewform?usp=sf_link
function sendNetworkLog(
    ...
    state,
    log_version) {
  var formid = "e/1FAIpQLSdMl_0v0sLjRwFPfoV1CT2NMI1as54yJRO91ks6_rgW5a-4Nw";
  var data = {
    "entry.570726217": uid,
    "entry.1215782652": time,
    "entry.1431647720": eventname,
    "entry.444268306": target,
    "entry.1064835857": info,
    "entry.1142582095": state,
    "entry.438266121": log_version,
  };
  var params = [];
  for (key in data) {
