...
| ---------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| synthesis completeness       | $$\alpha$$ | **Smaller** value leads to <ol><li>higher coverage.</li><li>lower accuracy (unstable generation) when $$\alpha \rightarrow 0$$.</li></ol>                                                                    |
| initial patch-sequence ratio | $$K$$      | **Larger** value leads to <ol><li>smaller receptive field.</li><li>more diversity.</li><li>unnatural transitions by capturing only fine-level movements.</li></ol> **Smaller** value leads to overfitting. |
| patch-size                   | $$p$$      | **Smaller** value leads to <ol><li>small receptive field.</li><li>less coherent results (low accuracy).</li></ol>                                                                                          |
